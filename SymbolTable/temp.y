...
void insertInt(char *symname, int val){
    ...
    printf("%s of type %s inserted with value = %d\n", new_node->var_name, new_node->type, new_node->val.ival);
}
void insertFloat(char *symname, float val){
    ...
    printf("%s of type %s inserted with value = %f\n", new_node->var_name, new_node->type, new_node->val.fval);
}
void insertDouble(char *symname, double val){
    ...
    printf("%s of type %s inserted with value = %lf\n", new_node->var_name, new_node->type, new_node->val.dval);
}
void insertChar(char *symname, char val){
    ...
    printf("%s of type %s inserted with value = %c\n", new_node->var_name, new_node->type, new_node->val.cval);
}
void insertString(char *symname, char val[]){
    ...
    printf("%s of type %s inserted with value = %s\n", new_node->var_name, new_node->type, new_node->val.sval);
}
void insertBoolean(char *symname, char *val){
    printf("var_name: %s value: %s\n", symname, val);
    struct Table *new_node;
    ...
    printf("%s of type %s inserted with value = %d\n", new_node->var_name, new_node->type, new_node->val.bval);
}
void printAll(){
    struct Table *ptr;
...
void printId(char *symname){
    ...
    int available = 0;
    while(ptr!=NULL){
    	if(ptr->var_name == symname){
    		printf("%s is of type %s having value = %d", symname, ptr->type, ptr->val.ival);
    		available = 1;
    	}
    	ptr=ptr->next;
    }
